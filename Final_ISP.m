clear all
clc
[Temp] = xlsread("E:\Books and pdfs\ISP\Data\Pak\Temp_Pak.xlsx");
[Horizontal] = xlsread("E:\Books and pdfs\ISP\Data\Pak\Horizontal_Pak.xlsx");
[Diffuse] = xlsread("E:\Books and pdfs\ISP\Data\Pak\Diffuse_Pak.xlsx");
[Albedo] = xlsread("E:\Books and pdfs\ISP\Data\Pak\Albedo_Pak.xlsx");
Data = [];
A_Final_Data = [];
for L = 1:325
